...
* Easy desktop switching
    * Switch virtual desktops naturally with your mouse, similar to macOS Mission Control
    * On Windows 11, smoother and more natural transition animations are supported
* Wheel double-click gesture
    * Double-click the wheel button to trigger a user-defined action
* Lightweight and easy installation
    * No system files are modified, and installation is quick and simple

## Notes
* This program is not compatible with Windows 8 or earlier!
